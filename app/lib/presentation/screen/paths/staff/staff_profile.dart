          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Padding(
              ...
              child: GridView.count(
                ...
                childAspectRatio: 3,
                children: [
                  _buildGridTile('User ID', user.uid),
                  _buildGridTile('Email', user.email ?? 'N/A'),
                  _buildGridTile('Display Name', user.displayName ?? 'N/A'),
                  _buildGridTile('Phone Number', user.phoneNumber ?? 'N/A'),
